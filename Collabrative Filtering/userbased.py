...
K = 30 # number of neighbors we'd like to consider
...
# #code for positive and negative iterations for each row
# pos = []
# neg = []
# for item in test_predictions[:1000]:
#     if (mse(test_predictions, test_targets)) >= 0.93:
#         pos.append(item)
#     else:
#         neg.append(item)
...
print(np.mean(mse(test_predictions, test_targets)))
